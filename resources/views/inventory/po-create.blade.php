<x-app-layout>
    ...
    <div class="page-header">
        <div>
            <h2 class="page-title">Buat Purchase Order</h2>
            <p class="page-subtitle">Pesan barang ke supplier</p>
        </div>
        <a href="{{ route('inventory.po.index') }}" class="btn-secondary">← Kembali</a>
    </div>

    <livewire:inventory.purchase-order.po-form />
