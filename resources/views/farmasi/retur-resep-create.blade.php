<x-app-layout>
    <x-slot name="title">Buat Retur Resep</x-slot>

    <div class="page-header">
        <div>
            <h2 class="page-title">Buat Retur Resep</h2>
            <p class="page-subtitle">Retur resep pasien yang sudah lunas, selama masih di hari yang sama</p>
        </div>
        <a href="{{ route('farmasi.retur-resep.index') }}" class="btn-secondary">← Kembali</a>
    </div>

    <livewire:farmasi.retur-resep.retur-resep-form />
