<x-app-layout>
    <x-slot name="title">Log Login User</x-slot>

    <div class="page-header">
        <div>
            <h2 class="page-title">Log Login User</h2>
            <p class="page-subtitle">Riwayat login pengguna sistem — khusus Super Admin</p>
        </div>
    </div>

    <livewire:pengaturan.login-log />
